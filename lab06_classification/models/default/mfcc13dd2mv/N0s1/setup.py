...
train_pickle_file = data_path + 'features/mfcc13/train.pkl'
test_pickle_file = data_path + 'features/mfcc13/test.pkl'

# features 
load_from_feature = False
feature_path = data_path + 'features/mfcc13/'
feature_args = {
    'spg': None,
    'Deltas': 'delta_delta2',
    'Norm': 'meanvar',
...
# output
output_path = write_path + "models/default/mfcc13dd2mv/N0s1/"
